		...
		const payload = {
			context: {
				client: {
					hl: 'ko',
					gl: 'KR',
					remoteHost: '211.244.161.100',
					deviceMake: '',
					deviceModel: '',
					visitorData: 'CgszYjVvb3diUmMtZyj9w5iJBg%3D%3D',
					userAgent:
						'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/92.0.4515.159 Safari/537.36,gzip(gfe)',
					clientName: 'WEB',
					clientVersion:
						this.session.defaults.headers['X-YouTube-Client-Version'],
					osName: 'Windows',
					osVersion: '10.0',
					originalUrl: 'https://www.youtube.com/watch?v=D7XSXVwkzF8',
					platform: 'DESKTOP',
					...
					mainAppWebInfo: {
						graftUrl: 'https://www.youtube.com/watch?v=D7XSXVwkzF8',
				...
				clickTracking: {
					clickTrackingParams: 'COQBELsvGAIiEwjX95zhgczyAhW5ilYBHdq_C98=',
				},
				adSignalsInfo: {
					params: [
						{
						...
						{
							key: 'brdim',
							value: '-7,0,-7,0,1920,0,974,1039,150,862',
						},
						{
							key: 'vis',
							value: '1',
